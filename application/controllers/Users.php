<?php
	class Users extends CI_Controller
	{
		...
		public function dashboard(){
			...
			$data['packDetails'] =$this->User_Model->packDetails();
		...
		public function add_package_data(){
			...
			$insertId=$this->User_Model->add_package_data();
			$data['paidData'] =$this->User_Model->paidData($insertId);

			$this->load->view('templates/header');
			$this->load->view('users/payPage',$data);
			$this->load->view('templates/footer');
		}

		public function striperesult(){
			require_once('application/libraries/stripe-php/init.php');
